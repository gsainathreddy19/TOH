...
public class thing : MonoBehaviour
{
    ...
    public static bool Cut(Transform victim, Vector3 _pos,GameObject obj)
    {
        ...
        GameObject rightSideObj = GameObject.Instantiate(obj);
        ...
        rightSideObj.GetComponent<simplechange>().onceGrasped = true;
       ...
       // leftSideObj.GetComponent<simplechange>().onceGrasped = true;
      //  leftSideObj.GetComponent<Behaviour>();
